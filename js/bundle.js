    ...
    function getStaticInformation(selector, activeClass) {
        ...
        elements.forEach(elem => {
            elem.addEventListener('click', (e) => {
                if (e.target.getAttribute('data-ratio')) {// Если на кликнутом диве присутствет атрибут радио, то 
                    ratio = +e.target.getAttribute('data-ratio'); // мы изменяем переменную ратио
...
function timer(id, deadline) {
    ...
    function setClock(selector, endtime) {
        const timer = document.querySelector(selector),
            ...
            timeInterval = setInterval(updateClock, 1000); // чтобы не мигал таймер при обновлении
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-08-29');
